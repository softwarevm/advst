...
export class RightSidebarComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    this.http.get(environment.apiUrl+'/obiettivo.php')
    .subscribe( response => {
      console.log(response)
      this.obiettivo_mensile = response[0].mensile
      this.obiettivo_annuale = response[0].annuale
    })
  ...
  update(event,tipo) {
    ...
    this.http.post(environment.apiUrl+'/aggiorna_obiettivo.php',JSON.stringify(obiettivo))
    .subscribe(response => {
      console.log(response)
      this.obiettivo_mensile = response[0].mensile
      this.obiettivo_annuale = response[0].annuale
  ...
  selezionaAnno(a) {
    localStorage.setItem('anno',a.value)
    console.log('->',a)
  }
}
